...
ActiveRecord::Schema.define(version: 20170408155111) do
  ...
  create_table "universities", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.index ["confirmation_token"], name: "index_universities_on_confirmation_token", unique: true, using: :btree
    t.index ["email"], name: "index_universities_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_universities_on_reset_password_token", unique: true, using: :btree
    t.index ["uid", "provider"], name: "index_universities_on_uid_and_provider", unique: true, using: :btree
  end
